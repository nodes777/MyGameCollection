...
import {
	sendGameToFireStore,
	getUserData,
} from "../api_requests/firebaseSendAndGet";
...
export default class HomeScreen extends React.Component {
	...
	componentDidMount() {
		...
		console.log(this.props.route.params.userToken);
		const uid = this.props.route.params.userToken;
		getUserData(uid).then((userDoc) => {
			console.log(userDoc);
			this.setState({ displayName: userDoc.displayName });
		});
	}
	render() {
